...
class BernoulliCoandaStrategy:
    ...
    def update_price(self, current_price: float, data=None):
        ...
        return {
            ...
            "signal": getattr(self, "last_signal", "neutral"),
        }
...
def create_bernoulli_coanda_strategy(name: str = "BCQ_V1", 
                                     auto_adapt: bool = True) -> BernoulliCoandaStrategy:
    """创建伯努利-康达策略实例"""
    params = BernoulliCoandaParameters()
    params.auto_adapt_enabled = auto_adapt
    return BernoulliCoandaStrategy(name=name, params=params)
