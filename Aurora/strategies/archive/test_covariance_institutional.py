...
from strategies.covariance_institutional_strategy import CovarianceInstitutionalStrategy
...
def main():
    ...
    # 初始化策略
    print("初始化协变机构策略...")
    strategy = CovarianceInstitutionalStrategy(initial_balance=100000)
    print("="*60)
