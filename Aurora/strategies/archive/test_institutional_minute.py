...
from strategies.institutional_minute_strategy import InstitutionalMinuteStrategy
...
def main():
    ...
    # 生成模拟数据（分钟级）
    print("生成模拟数据...")
    data = generate_simulation_data(days=200, freq="5min", volatility=0.001, trend_strength=0.0001)
    ...
    # 初始化策略
    print("初始化机构分钟级策略...")
    strategy = InstitutionalMinuteStrategy(initial_balance=100000)
    print("="*60)
