...
SLIPPAGE = 0.0001           # 滑点
MAX_DAILY_TRADES = 200      # 高频上限
MAX_SINGLE_LOSS = 0.003     # 单笔最大亏损0.3%
MAX_DRAW_DOWN_LIMIT = 0.03  # 最大回撤3%
MODEL_PATH = "final_strategy_ml_memory.json"
...
class MarketClassifier:
    ...
    def classify(df):
        close = df.close
        ema10 = IndicatorCalculator.EMA(close, 10)
        ema20 = IndicatorCalculator.EMA(close, 20)
        trend = (ema10.iloc[-1] - ema20.iloc[-1]) / (ema20.iloc[-1] + 1e-8)
