...
from strategies.quantum_covariant_strategy import QuantumTradingSystem


def generate_simulation_data(days=10, freq="5min", volatility=0.001, trend_strength=0.0001):
    """
    生成模拟数据
...
def main():
    ...
    # 初始化策略
    print("初始化量子矩阵协变策略...")
    strategy = QuantumTradingSystem(initial_balance=100000)
    print("="*60)
