...
class GyroEvolve:
    ...
    def get_reward(self, metrics: StrategyMetrics, position_change):
        ...
        if metrics.sortino_ratio >= 1.5:
            ...
            reward -= (1.5 - metrics.sortino_ratio) * 5
...
class GyroMinuteStrategyV5:
    ...
    def should_trade(self, adjust, price_window, min_holding_minutes=30):
        if abs(adjust.main_pos) < 0.00085:
            return False
...
def main():
    print("="*90)
    print("陀螺策略V5 - 最小优化版本")
    print("改进: 增加Sortino激励权重、略微降低信号阈值提高交易频率")
    print("="*90)
