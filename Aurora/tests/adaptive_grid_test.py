...
def test_adaptive_grid_trading(market_type: str, initial_balance: float = 100000):
    """
    测试自适应网格交易策略
    """
    print(f"\n" + "="*60)
    print(f"测试: {market_type} 市场 (自适应网格交易)")
    print("="*60)
    ...
    # 创建自适应网格交易策略
    grid = AdaptiveGridTrading(
        base_price=data.iloc[0], 
        grid_spacing=0.002,  # 初始网格间距
...
def main():
    ...
    for market_type in market_types:
        result = test_adaptive_grid_trading(market_type)
