...
from strategies.fund_optimized_strategy import FundOptimizedStrategy
...
def main():
    ...
    for market_type in market_types:
        ...
        # 测试资金优化策略
        strategy = FundOptimizedStrategy(base_price=data['close'].iloc[0])
        results[market_type] = test_strategy(strategy, data, f"fund_optimized")
