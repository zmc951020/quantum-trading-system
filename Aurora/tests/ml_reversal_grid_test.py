...
def test_ml_reversal_grid_trading(market_type: str, initial_balance: float = 100000):
    """
    测试机器学习反转网格交易策略
    """
    print(f"\n" + "="*60)
    print(f"测试: {market_type} 市场 (机器学习反转网格交易)")
    print("="*60)
...
def main():
    ...
    """
    print("="*60)
    print("机器学习反转网格交易策略测试")
    print("="*60)
    print("针对下跌市场的机器学习反转信号交易策略")
    print("="*60)
    ...
    for market_type in market_types:
        result = test_ml_reversal_grid_trading(market_type)
