...
try:
    from strategies.market_adaptive_strategy import MarketAdaptiveStrategy
...
def test_strategy(strategy_name: str, strategy_class, data, market_type, initial_balance: float = 100000):
    ...
    return {
        ...
        'strategy_switch_count': perf.get('strategy_switch_count', 0),
...
def main():
    ...
    strategies = {
        'market_adaptive_strategy': MarketAdaptiveStrategy,
    ...
    for market_type in market_types:
        ...
        for strategy_name, strategy_class in strategies.items():
            ...
            try:
                ...
                if 'strategy_switch_count' in result:
                    print(f"    策略切换次数: {result['strategy_switch_count']:3d}")
