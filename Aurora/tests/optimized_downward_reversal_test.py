...
def test_optimized_downward_reversal(market_type: str, initial_balance: float = 100000):
    """
    测试优化的下跌市场反转网格交易策略
    """
    print(f"\n" + "="*60)
    print(f"测试: {market_type} 市场 (优化的下跌市场反转网格交易)")
    print("="*60)
    ...
    # 创建优化的下跌市场反转网格交易策略
    grid = OptimizedDownwardReversalGrid(
...
def main():
    ...
    """
    print("="*60)
    print("优化的下跌市场反转网格交易策略测试")
    print("="*60)
    print("使用分钟级指标确立支撑位和压力位的下跌市场反转策略")
    print("="*60)
    ...
    for market_type in market_types:
        result = test_optimized_downward_reversal(market_type)
