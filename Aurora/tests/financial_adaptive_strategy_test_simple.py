...
def generate_simple_market_data(days=20, time_frame=5):
    """生成简化的混合市场数据
    ...
    # 市场阶段划分
    phases = [
        {"type": "NARROW_RANGE", "days": 5, "volatility": 0.2, "trend": 0},
        {"type": "STRONG_UP", "days": 5, "volatility": 0.15, "trend": 0.2},
        {"type": "STRONG_DOWN", "days": 5, "volatility": 0.15, "trend": -0.15},
        {"type": "LOW_VOLATILITY", "days": 5, "volatility": 0.1, "trend": 0}
    ]
...
def run_simple_test():
    ...
    try:
        # 生成简化的混合市场数据
        print("生成简化的混合市场数据...")
        df = generate_simple_market_data(days=20, time_frame=5)
