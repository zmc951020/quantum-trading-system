...
try:
    from strategies.ml_adaptive_grid import MLAdaptiveGridTrading
...
def test_ml_adaptive_grid_trading(market_type: str, initial_balance: float = 100000):
    """
    测试机器学习自适应网格交易策略
    """
    print(f"\n" + "="*60)
    print(f"测试: {market_type} 市场 (机器学习自适应网格交易)")
    print("="*60)
...
def main():
    ...
    """
    print("="*60)
    print("机器学习自适应网格交易策略测试")
    print("="*60)
    print("使用机器学习自动切换不同市场的网格策略")
    print("="*60)
    ...
    for market_type in market_types:
        result = test_ml_adaptive_grid_trading(market_type)
