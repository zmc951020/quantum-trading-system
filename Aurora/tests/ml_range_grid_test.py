...
def test_strategy(strategy_name: str, strategy_class, data, initial_balance: float = 100000):
    ...
    """
    # 创建策略实例
    if strategy_name in ['ml_range_grid', 'final_market_adaptive']:
    ...
    for i, price in enumerate(data):
        ...
        if i >= 20:
            ...
            if strategy_name in ['ml_range_grid', 'final_market_adaptive', 'enhanced_grid', 'adaptive_grid']:
