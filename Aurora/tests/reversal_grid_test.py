...
def test_reversal_grid_trading(market_type: str, initial_balance: float = 100000):
    """
    测试反转网格交易策略
    """
    print(f"\n" + "="*60)
    print(f"测试: {market_type} 市场 (反转网格交易)")
    print("="*60)
...
def main():
    ...
    for market_type in market_types:
        result = test_reversal_grid_trading(market_type)
