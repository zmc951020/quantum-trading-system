...
struct TORCH_API miopen_ctc_loss {
  ...
  static constexpr const char* name = "aten::miopen_ctc_loss";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "miopen_ctc_loss(Tensor log_probs, Tensor targets, int[] input_lengths, int[] target_lengths, int blank, bool deterministic, bool zero_infinity) -> (Tensor, Tensor)";
...
struct TORCH_API miopen_ctc_loss_Tensor {
  ...
  static constexpr const char* schema_str = "miopen_ctc_loss.Tensor(Tensor log_probs, Tensor targets, Tensor input_lengths, Tensor target_lengths, int blank, bool deterministic, bool zero_infinity) -> (Tensor, Tensor)";
...
struct TORCH_API miopen_ctc_loss_out {
  ...
  static constexpr const char* schema_str = "miopen_ctc_loss.out(Tensor log_probs, Tensor targets, int[] input_lengths, int[] target_lengths, int blank, bool deterministic, bool zero_infinity, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))";
