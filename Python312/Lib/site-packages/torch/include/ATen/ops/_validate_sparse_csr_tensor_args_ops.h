...
struct TORCH_API _validate_sparse_csr_tensor_args {
  ...
  static constexpr const char* schema_str = "_validate_sparse_csr_tensor_args(Tensor crow_indices, Tensor col_indices, Tensor values, int[] size, bool? check_pinning=None) -> ()";
