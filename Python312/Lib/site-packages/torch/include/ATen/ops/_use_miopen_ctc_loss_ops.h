...
struct TORCH_API _use_miopen_ctc_loss {
  using schema = bool (const at::Tensor &, const at::Tensor &, at::IntArrayRef, at::IntArrayRef, int64_t);
  using ptr_schema = schema*;
  // See Note [static constexpr char* members for windows NVCC]
  static constexpr const char* name = "aten::_use_miopen_ctc_loss";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_use_miopen_ctc_loss(Tensor log_probs, Tensor targets, int[] input_lengths, int[] target_lengths, int blank) -> bool";
...
struct TORCH_API _use_miopen_ctc_loss_Tensor {
  ...
  static constexpr const char* schema_str = "_use_miopen_ctc_loss.Tensor(Tensor log_probs, Tensor targets, Tensor input_lengths, Tensor target_lengths, int blank) -> bool";
