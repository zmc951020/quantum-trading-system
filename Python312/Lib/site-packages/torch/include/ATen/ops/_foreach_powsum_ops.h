...
struct TORCH_API _foreach_powsum_Scalar {
  using schema = ::std::vector<at::Tensor> (at::TensorList, const at::Scalar &, ::std::optional<at::ScalarType>);
  using ptr_schema = schema*;
  // See Note [static constexpr char* members for windows NVCC]
  static constexpr const char* name = "aten::_foreach_powsum";
  static constexpr const char* overload_name = "Scalar";
  static constexpr const char* schema_str = "_foreach_powsum.Scalar(Tensor[] self, Scalar ord=2, ScalarType? dtype=None) -> Tensor[]";
...
struct TORCH_API _foreach_powsum_Scalar_out {
  ...
  static constexpr const char* schema_str = "_foreach_powsum.Scalar_out(Tensor[] self, Scalar ord=2, ScalarType? dtype=None, *, Tensor(a!)[] out) -> ()";
